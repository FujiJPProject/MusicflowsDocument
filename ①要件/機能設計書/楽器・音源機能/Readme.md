...
| ギター音源       | ギター系の音源                     | コードストローク、アルペジオ、リフ、メロディなど、ギターらしいパートを作成できるようにする |
...
| ベースシンセ     | シンセサイザー系のベース音源       | 電子的で太い低音や、EDM・ゲーム音楽系のベースラインを作成できるようにする                  |
...
| ギター音源       | 初期版では少数のプリセットに限定する。コードストロークやカッティングなど細かい奏法再現は難しいため、まずはコード伴奏・単音フレーズ向けの基本音色を優先する。 |
...
| ベースシンセ     | 低音が大きくなりすぎないよう音量初期値を控えめにする。音が太くなりすぎて他パートを邪魔しないよう、プリセット数と音色の強さを制御する。                       |
